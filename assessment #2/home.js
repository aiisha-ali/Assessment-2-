...
const canWeDeliver = zipCode => {
   for (let i = 0; i < deliveryAreaZipCodes.length; i++){
            ...
            else { (zipCode !== deliveryAreaZipCodes) 
              return ("You're not our delivery zone!")
            }
        }
     }
 ...
 let zipCode = 55337
 console.log(canWeDeliver(55337))
...
const newDeals = deals[0].title.replace('5', '0')
...
const newDesc = desc.replace('March', 'April')
