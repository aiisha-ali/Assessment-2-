...
//CODE HERE
const empOne = new Employee('Aisha', ('weekday night, weekday morning'));
...
//CODE HERE
const manager = new Manager('Rania', 'weekday mornings, weekday afternoons', 'Kafiya and Hana');
